...
public class AutonomousManager {
	...
	public AutonomousManager(Map<String, Pose2d> poses, Map<String, Command> commands, PathConstraints constraints,
		...
		if (warmupPathfind && AutoBuilder.isConfigured()) PathfindingCommand.warmupCommand().schedule();
	...
	/**
	 * Puts the Flare auto builder in the given tab on ShuffleBoard. <i>The Flare widget needs to
	 * be installed.</i>
	 *
	...
	/**
	 * Puts the Flare auto builder in the default tab ({@link #kWidgetDefaultTab}) with the default
	 * title {@link #kWidgetDefaultTitle} on ShuffleBoard. <i>The Flare widget needs to be
	 * installed.</i>
	 */
