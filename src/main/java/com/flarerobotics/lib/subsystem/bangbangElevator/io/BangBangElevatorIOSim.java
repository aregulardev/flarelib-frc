...
import com.flarerobotics.lib.control.SubsystemRatios;
import com.flarerobotics.lib.sim.ElevatorSimTilted;
...
public class BangBangElevatorIOSim implements BangBangElevatorIO {
	...
	public void updateInputs(BangBangElevatorIOInputs inputs) {
		...
		inputs.supplyCurrentAmps = m_sim.getSupplyCurrentDrawAmps();
		inputs.statorCurrentAmps = m_sim.getCurrentDrawAmps();
