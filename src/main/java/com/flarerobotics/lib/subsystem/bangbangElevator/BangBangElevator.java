package com.flarerobotics.lib.subsystem.bangbangElevator;
...
public abstract class BangBangElevator extends SubsystemBase {
	...
	public BangBangElevator(BangBangElevatorIO io, double forwardOutput, boolean isTorqueCurrent, double stallVelocity,
		...
		m_io = io;
		m_name = name;
		m_tempAlert = new Alert(name + " motors overheating, system function may be limited!", AlertType.kWarning);
		m_disconnectAlert = new Alert(name + " motors disconnected!", AlertType.kWarning);
