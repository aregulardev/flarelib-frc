...
public class LimelightHelpers {
	...
	static final String sanitizeName(String name) {
		if (name == "" || name == null) { return "limelight"; }
		return name;
	}
	...
	public static CompletableFuture<Boolean> takeSnapshot(String tableName, String snapshotName) {
		return CompletableFuture.supplyAsync(() -> { return SYNCH_TAKESNAPSHOT(tableName, snapshotName); });
	}
	...
	private static boolean SYNCH_TAKESNAPSHOT(String tableName, String snapshotName) {
		...
		try {
			...
			if (snapshotName != null && snapshotName != "") { connection.setRequestProperty("snapname", snapshotName); }
