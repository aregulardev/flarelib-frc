...
public class ObjectDetectionIOPhotonVision implements ObjectDetectionIO {
	...
	public ObjectDetectionIOPhotonVision(String name, Translation2d robotToCamera, Supplier<Pose2d> robotPoseSupplier,
		...
		YawFudgeFactorTangent = new LoggedTunableNumber("ObjectDetection/PV/" + name + "/YawFudgeFactorTangent", 0.5);
		YawFudgeFactorCosine = new LoggedTunableNumber("ObjectDetection/PV/" + name + "/YawFudgeFactorCosine", 0.1);
	}
