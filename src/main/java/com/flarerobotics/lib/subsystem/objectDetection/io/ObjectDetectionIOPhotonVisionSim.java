...
public class ObjectDetectionIOPhotonVisionSim extends ObjectDetectionIOPhotonVision {
	...
	public ObjectDetectionIOPhotonVisionSim(String name, String gamePieceName, Transform3d robotToCamera,
			Supplier<Pose2d> poseSupplier, double camHeightGroundMeters, double camYawDeg, double camPitchDeg,
			double targetHeightMetersStanding, double targetHeightMetersFallen, double arMinStanding,
			double arMaxStanding, double maxYawDegrees, SimCameraProperties cameraProperties,
			Supplier<List<VisionTargetSim>> targets) {
		super(name, new Translation2d(robotToCamera.getX(), robotToCamera.getY()), poseSupplier, camHeightGroundMeters,
