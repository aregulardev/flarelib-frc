package com.flarerobotics.lib.subsystem.rollers;

import com.flarerobotics.lib.subsystem.rollers.GenericRollerSubsystem.GenericRollerVoltage;
...
public abstract class GenericRollerSubsystem<Setpoint extends GenericRollerVoltage> extends SubsystemBase {
	...
	private GenericRollerIOInputsAutoLogged m_inputs = new GenericRollerIOInputsAutoLogged();
	...
	public GenericRollerSubsystem(String rollerId, GenericRollerIO io) {
		m_id = rollerId;
		m_io = io;
		m_disconnectedAlert = new Alert(m_id + "'s motor has disconnected!", AlertType.kWarning);
	}
