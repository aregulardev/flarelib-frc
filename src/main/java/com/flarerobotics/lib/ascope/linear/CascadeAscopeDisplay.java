 ...
 * to Network Tables (via Akit Logger) for visualization in AdvantageScope.
 *
 * <p>
 * Model:
...
public class CascadeAscopeDisplay {
     ...
     *                                the zero point
     *                                of the height sensor isn't actually the bottom
     *                                of the elevator.
     * @param heightSupplierMeters    The supplier returning the elevator's current
     *                                raw height (in meters).
     * @param angleRadians            The tilt of the elevator as a Rotation3d (use
     *                                Rotation3d.kZero for upright).
     * @param elevatorMaxHeightMeters The physical max height (in meters) of the
     *                                elevator.
     */
    public CascadeAscopeDisplay(
            String name,
            int stages,
            double offsetMeters,
            Supplier<Double> heightSupplierMeters,
            Supplier<Rotation3d> angleRadians,
     ...
     * @param stages                  The number of stages in the elevator (>= 1).
     * @param offsetMeters            A baseline offset (in meters). Often used if
     *                                the zero point of the height sensor isn't
     *                                actually the bottom of the elevator.
     * @param heightSupplierMeters    The supplier returning the elevator's current
     *                                raw height (in meters).
     * @param elevatorMaxHeightMeters The physical max height (in meters) of the
     *                                elevator.
